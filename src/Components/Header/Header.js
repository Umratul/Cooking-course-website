        ...
        <NavLink className="title fs-3 fw-bold text-danger fst-italic px-2 py-1 me-5" to="/Home">Cooking Studio <FontAwesomeIcon icon={faUtensils} /></NavLink>
          ...
          <div className="collapse navbar-collapse d-flex justify-content-end" id="navbarNav">
            ...
            <div className="nav-container m-2">
                ...
                <NavLink className="single-nav fw-bold text-dark border border-3 border-info rounded-3 px-2 py-1 me-5" to="/Contact">Contact Us <FontAwesomeIcon icon={faEnvelope} /></NavLink>
                </div>
            </ul>
          </div>
        </div>
